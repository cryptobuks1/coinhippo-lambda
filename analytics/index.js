  ...
  if (route === '/markets/status') {
    ...
    if (coinsData) {
      if (_.mean(coinsData.map((coinData, i) => _.takeRight(coinData.months, 3).filter((priceData, j) => priceData.close < priceData.open && (j < 1 || priceData.close < _.takeRight(coinData.months, 3)[0].low)).length / (i + 1))) >= coinsData.length / 2) {
        ...
        html = '<span class="h-5 flex items-center font-normal space-x-1"><span>Starting of</span><span class="font-bold">Bearish</span><span class="text-xl">😢</span></span>';
      }
        ...
        html = '<span class="h-5 flex items-center font-normal space-x-1"><span class="text-xl">😅</span><span>smells like</span><span class="font-bold">Bear Market</span></span>';
      }
        ...
        html = '<span class="h-5 flex items-center font-normal space-x-1"><span>Starting of</span><span class="font-bold">Bullish</span><span class="text-xl">😁</span></span>';
      }
        ...
        html = '<span class="h-5 flex items-center font-normal space-x-1"><span class="text-xl">🧐</span><span>smells like</span><span class="font-bold">Bull Market</span></span>';
      }
      else {
        status = 'sideway';
        text = 'Sideways';
